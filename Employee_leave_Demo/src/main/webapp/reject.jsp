...
background-image: url("https://images.pexels.com/photos/1024248/pexels-photo-1024248.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500.png");
}
</style>
</head>
sss
<div class="container-fluid px-1 py-5 mx-auto">
  ...
  <div class="card">
              ...
              <form method="post" action="reject-pro.jsp" class="form-card">
...
<input type="submit" value="REJECT LEAVE REQUEST">
</div>
</form>
            </div>
        </div>
